...
class PieceSelector:
    ...
    def verify_piece(self, piece_index, mif):
        ...
        for part in range(16):
            try:
                ...
                print(f"piece {piece_index} not yet complete")
                ...
                return
        print(f"yeee piece {piece_index} is complete!")
        ...
        if mif.piece_hash_in_bytes(piece_index) == digest:
            ...
            self.unverified_pieces.remove(piece_index)
    ...
    def verify_completed_pieces(self, mif):
        ...
        for piece in self.unverified_pieces:
    ...
    def get_completed_pieces_from_peers(self, peers):
        for peer in peers:
            for piece in peer.get_completed_pieces():
                self.unverified_pieces.add(piece)
